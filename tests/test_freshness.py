...
def run():
    with tempfile.TemporaryDirectory() as td:
        ...
        r = api.gemini_transcribe(str(src), gemini_api_key="fake", diarized_srt_file=True)
        ...
        r = api.gemini_transcribe(str(src), force=True, gemini_api_key="fake", diarized_srt_file=True)
